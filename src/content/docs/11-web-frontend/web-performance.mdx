...
Example budget, measured on this page’s production build under a cold cache, 4G profile, 4× CPU slowdown, 1365×768 viewport: if the trace records 1.8 s LCP and the product budget is 2.5 s, the remaining margin is `2.5 - 1.8 = 0.7 s`. If JavaScript transfer is 92 KB compressed and the budget is 120 KB, 28 KB remains. These figures are a measurement plan and arithmetic model; they are not universal results until a trace captures them in this repository.
